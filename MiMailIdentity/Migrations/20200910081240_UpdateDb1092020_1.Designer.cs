...
namespace MiMailIdentity.Migrations
{
    ...
    [Migration("20200910081240_UpdateDb1092020_1")]
    partial class UpdateDb1092020_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiMailIdentity.Models.BuildingItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MiMailIdentity.Models.CustomerCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MiMailIdentity.Models.CustomerCampaign", b =>
                {
                    b.HasOne("MiMailIdentity.Models.Campaign", "GetCampaign")
                        .WithMany("GetCustomerCampaigns")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MiMailIdentity.Models.Customer", "GetCustomer")
                        .WithMany()
