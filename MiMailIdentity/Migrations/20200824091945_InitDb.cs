        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CampaignCategories_CampaignCategories_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalMail = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UPD_UID = table.Column<string>(nullable: true),
                    UPD_DTTM = table.Column<DateTime>(nullable: false),
                    CampaignCateId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    Icon = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Campaigns_CampaignCategories_CampaignCateId",
                        column: x => x.CampaignCateId,
                        principalTable: "CampaignCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UPD_UID = table.Column<string>(nullable: true),
                    UPD_DTTM = table.Column<DateTime>(nullable: false),
                    CustomerCateId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    Avatar = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_CustomerCategories_CustomerCateId",
                        column: x => x.CustomerCateId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartActiveDate = table.Column<DateTime>(nullable: true),
                    EndActiveDate = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignCategories_ParentId",
                table: "CampaignCategories",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_Campaigns_CampaignCateId",
                table: "Campaigns",
                column: "CampaignCateId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_CustomerCateId",
                table: "Customers",
                column: "CustomerCateId");
